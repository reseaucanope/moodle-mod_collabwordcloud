...
if (!$wordcloud->is_started()) {
    $output .= get_string('activitenotstarted','mod_collabwordcloud', strftime(get_string('strftimedaydatetime','core_langconfig'), $wordcloud->activity->timestart));
    $closed = true;
}
...
$d3url = new moodle_url('/mod/collabwordcloud/js/d3.v3.min.js');
$d3cloudurl = new moodle_url('/mod/collabwordcloud/js/d3.layout.cloud.js');
